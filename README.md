...
Это мобильная версия ранее разработанного SPA приложения. Это мобильное приложение и прошлое SPA используют один и тот же API на Laravel. [Ссылка на репозиторий](https://github.com/littlegirl-yar/parking-web) SPA приложения, где есть код разработанного API и более подробное описание использованных технологий и навыков.  
